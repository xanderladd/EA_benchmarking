...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 SKv3_1 /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/allen_mappings/pyNeuroGPU_unix2/python/x86_64/SKv3_1.mod\n");
