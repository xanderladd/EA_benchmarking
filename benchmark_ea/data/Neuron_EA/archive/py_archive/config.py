...
run_volts_path ='../NeuroGPU_EA/' # archival: '../../run_volts_bbp_full_gpu_tuned/'
# original model
...
# new mode
objectives_file = h5py.File('../NeuroGPU_EA/python/objectives/allen485835016_objectives.hdf5', 'r')
target_volts_path = '../NeuroGPU_EA/python/target_volts/target_volts_485835016.hdf5'
