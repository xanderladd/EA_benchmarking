...
def assemble_experiment_tables():
    ...
    for extension in experiment_extensions:
        gpu_df = pd.read_csv(f'data//python/regular_outputs/{extension}')   
        neuron_df = pd.read_csv(f'data/Neuron_EA/outputs/{extension}')
        summit_df = pd.read_csv(f'data/NeuroGPU_EA/python/summit_outputs/{extension}')   
        ipfx_df = pd.read_csv(f'data/NeuroGPU_EA/python/ipfx_outputs/{extension}')
        gpu_df_6 = pd.read_csv(f'data/GPU_genetic_alg/python/6GPU_outputs/{extension}')
        gpu_df_8 = pd.read_csv(f'data/GPU_genetic_alg/python/8SF_outputs/{extension}')
