...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im /global/cscratch1/sd/zladd/benchmarking/core_neuron_genetic_alg/python/Im.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/cscratch1/sd/zladd/benchmarking/core_neuron_genetic_alg/python/Im.mod";
static const char* nmodl_file_text = 
