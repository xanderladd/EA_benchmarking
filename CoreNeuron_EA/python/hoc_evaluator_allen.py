...
def run_model(param_set, stim_name_list, max_stims):
    """
    procedure to run model using core neuron
    """
...
def evaluate_score_function(stim_name_list, target_volts_list, data_volts_list, weights, n_stims, n_sfs):
    """
    calculate score for a set of stimuli, score functions and weights.
    :param n_stims: number of stimuli to use
    :param n_sfs: number of score functions to use
    :param weights: (optional) list of weights for score function
    """
...
class hoc_evaluator(bpop.evaluators.Evaluator):
    """
    hoc evaluator class for core_neuron enabled hoc evaluator
    :param args: parsed args from optimize_parameters.py
    :param logger: logger from optimize_parameters.py
    ...
    def evaluate_with_lists(self, param_values):
        """
        key function for evaluating objective function for coreneuron
        hoc evaluator. 
        :param param_values: list of paramterizations that are generated from EA. Should have shape (population_size, #parameters)
        :return scores: list of scores corresponding to objective function for each parameter set.
        """
