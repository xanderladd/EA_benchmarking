...
#     for chunk_end in range(20,len(args),20):
#         if not res:
#             res = p.map(wrap_para,args[chunk_end-20:chunk_end])
#         else:
#             continue
#             #res = np.append(res, p.map(wrap_para,args[chunk_end-20:chunk_end]), axis=1)
